...
import { createService } from "../core/api/service.requests";
import { IServiceCreateRequest } from "../core/models/service.interface";
...
const AddService = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            const reqBody: IServiceCreateRequest = {
                active: values.active,
                service_group_id: parseInt(values.service_group.value!),
                description: values.description,
                name: values.name,
            };
            createService(reqBody).then(() => {
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            <Card>
                <Card.Header>
                    <h4 className="text-lg text-gray-800 font-bold">Hizmet Ekle</h4>
                </Card.Header>
                <Card.Body>
