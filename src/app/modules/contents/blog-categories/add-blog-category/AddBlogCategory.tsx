...
import { IBlogCategoryRequest } from "../core/models/blog-category.interface";
...
import { addBlogCategory } from "../core/api/blog-category.request";
...
const AddBlogCategory = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      url: "",
      active: true,
    } as IBlogCategoryRequest,
    validationSchema: validationSchema,
    onSubmit: (values) => {
      addBlogCategory(values).then(() => {
