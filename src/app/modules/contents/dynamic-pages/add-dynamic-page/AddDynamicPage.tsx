...
import { addDynamicPage } from "../core/api/dynamic-page.resuest";
import { IDynamicPageRequest } from "../core/models/dynamic-page";
...
const AddDynamicPage = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      url: "",
      active: true,
    } as IDynamicPageRequest,
    validationSchema: validationSchema,
    onSubmit: (values) => {
      addDynamicPage(values).then(() => {
  ...
  return (
    <form className="container" onSubmit={formik.handleSubmit}>
      <Card>
        <Card.Header>
          <h4 className="text-lg font-bold">Sayfa Ekle</h4>
        </Card.Header>
        <Card.Body>
