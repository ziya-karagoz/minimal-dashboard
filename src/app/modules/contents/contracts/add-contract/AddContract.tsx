...
import { addContract } from "../core/api/contract.request";
import { IContractRequest } from "../core/models/contract.interface";
...
const AddContract = () => {
  ...
  return (
    <form className="container" onSubmit={formik.handleSubmit}>
      <Card>
        <Card.Header>
          <h4 className="text-lg font-bold">Sözleşme Ekle</h4>
        </Card.Header>
        <Card.Body>
