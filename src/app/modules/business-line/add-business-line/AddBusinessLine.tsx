...
import { createBusinessLine } from "../core/api/business-line.requests";
...
const AddBusinessLine = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            createBusinessLine(values).then(() => {
                toast.success("İş Kolu başarıyla eklendi");
                navigate(-1);
            });
        },
    });
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            <Card>
                <Card.Header>
                    <h4 className="text-lg text-gray-800 font-bold">İş Kolu Ekle</h4>
                </Card.Header>
                <Card.Body>
