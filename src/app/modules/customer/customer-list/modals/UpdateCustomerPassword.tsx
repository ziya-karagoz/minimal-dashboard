...
import { ICustomerUpdatePasswordRequest } from "../../core/models/customer.interface";
import * as Yup from "yup";
import Modal from "@base/components/common/modals/Modal";
import { updateCustomerPassword } from "../../core/api/customer.request";
...
const UpdateCustomerPassword: React.FC<Props> = ({ customerId, open, onClose }) => {
    const formik = useFormik({
        initialValues: {
            password: "",
            password_confirm: "",
        } as ICustomerUpdatePasswordRequest,
        validationSchema: validateSchema,
        onSubmit: (values) => {
            if (customerId)
                updateCustomerPassword({ id: customerId!, data: values }).then(() => {
