...
import { IUserUpdatePasswordRequest } from "../../core/models/user.interface";
import * as Yup from "yup";
import Modal from "@base/components/common/modals/Modal";
import { updateUserPassword } from "../../core/api/user.request";
...
const UpdateUserPassword: React.FC<Props> = ({ userId, open, onClose }) => {
    const formik = useFormik({
        initialValues: {
            password: "",
            password_confirm: "",
        } as IUserUpdatePasswordRequest,
        validationSchema: validateSchema,
        onSubmit: (values) => {
            if (userId)
                updateUserPassword({ id: userId!, data: values }).then(() => {
