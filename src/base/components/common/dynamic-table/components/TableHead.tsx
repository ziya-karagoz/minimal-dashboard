...
export default function TableHead<T>({
  ...
  const HeadCellItem = ({ headCell }: HeadCellItemProps) => {
    ...
    if (roleCheck)
      return (
        <th align={"left"}>
          <div className="dynamic-table-head d-flex align-items-center justify-content-start gap-1">
            {headCell.filterable ? (
              <TableDropdown<T>
                headCell={headCell}
            ...
            <div
              ...
              className={`cursor-pointer dynamic-table-head d-flex align-items-start justify-content-start gap-1 ${clsx(
                {
                  "text-secondary":
