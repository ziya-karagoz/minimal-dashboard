...
const Sidebar = () => {
    ...
    return (
        <div
            className={clsx("relative min-h-screen bg-white shadow-xl hidden lg:block", {
                "w-72": open,
                "w-20": !open,
        ...
        >
            <div className={clsx(
                " min-h-screen p-5  pt-8 duration-300  hidden lg:block  fixed top-0 left-0 h-full bg-white z-50",
                {
                    "w-72": open,
                    "w-20": !open,
                }
